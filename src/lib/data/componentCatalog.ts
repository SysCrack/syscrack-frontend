...
export const COMPONENT_CATALOG: ComponentCatalogEntry[] = [
    ...
    // ── Compute ───────────────────────────────────
    {
        ...
        defaultSpecificConfig: { instanceType: 'medium', autoScaling: true, minInstances: 1, maxInstances: 10, distributedTransaction: 'none', sagaCompensation: 'choreography' },
    ...
    },
    {
        ...
        category: 'techniques',
        priority: 'p2',
        description: 'Change Data Capture — tail DB log and emit change events to MQ/derived store',
        defaultSharedConfig: BASE_SHARED,
        defaultSpecificConfig: {
            captureMode: 'log-tail',
            captureLatencyMs: 200,
            includeDeletes: true,
            snapshotOnStart: false,
            snapshotLatencyMs: 5000,
        },
        applicableLayers: { scaling: false, consistency: false, resilience: false, trafficControl: false, sharding: false },
    },
